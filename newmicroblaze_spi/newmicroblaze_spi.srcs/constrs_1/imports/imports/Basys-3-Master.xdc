...
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports {cs_n_0}];#Sch name = JB7
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports {miso_0}];#Sch name = JB8
