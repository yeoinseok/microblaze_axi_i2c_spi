...
HD_PWD='D:/pr0503_microblaze_axi_spi_i2c/microblaze_i2c/microblaze_i2c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_i2c_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_i2c_wrapper.tcl
