...
HD_PWD='D:/pr0503_microblaze_axi_spi_i2c/microblaze_i2c/microblaze_i2c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_i2c_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_i2c_wrapper.tcl -notrace
